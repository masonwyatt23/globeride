/**
 * FeatureGlobePreview unit tests — pure vitest, node environment (no DOM).
 *
 * Exercises the gate logic that FeatureGlobePreview uses to decide whether to
 * mount a live Cesium scene or fall back to the static SVG.  The three gates
 * are: ion token present · WebGL available · hasSufficientHardware.
 *
...
/** Mirrors FeatureGlobePreview's canShow logic. */
...
// ---------------------------------------------------------------------------
describe('FeatureGlobePreview gate: no token', () => {
...
// ---------------------------------------------------------------------------
describe('FeatureGlobePreview gate: no WebGL', () => {
...
// ---------------------------------------------------------------------------
// Test 3 — low-end hardware → SVG fallback
// ---------------------------------------------------------------------------
describe('FeatureGlobePreview gate: low-end hardware', () => {
...
// ---------------------------------------------------------------------------
describe('FeatureGlobePreview gate: all pass', () => {
